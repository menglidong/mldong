...
INSERT INTO `sys_menu` VALUES ('25', '1', '参数配置', '10.20', 'sys:config:index', 'edit', '2', '2020-11-08 16:39:05.673', '2020-11-08 16:39:05.673', '1');
INSERT INTO `sys_menu` VALUES ('26', '1', '接口清单', '1.10', 'sys:menu:mapilist', 'list', '2', '2020-11-08 17:17:28.527', '2020-11-08 17:40:07.579', '1');
...
CREATE TABLE `sys_request_log` (
  ...
  `is_deleted` tinyint(1) unsigned DEFAULT '1' COMMENT '是否删除(1->未删除|NO,2->已删除|YES)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COMMENT='请求日志';
