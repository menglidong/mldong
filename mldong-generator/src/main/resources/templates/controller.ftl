...
public class ${table.className}Controller {
	...
	@PostMapping("save")
	@ApiOperation(value="添加${table.remark?replace("表","")}", notes="${moduleName}:${table.tableCameName?replace(moduleName,"")?uncap_first}:save")
	...
	@PostMapping("update")
	@ApiOperation(value="修改${table.remark?replace("表","")}", notes="${moduleName}:${table.tableCameName?replace(moduleName,"")?uncap_first}:update")
	...
	@PostMapping("remove")
	@ApiOperation(value="删除${table.remark?replace("表","")}", notes="${moduleName}:${table.tableCameName?replace(moduleName,"")?uncap_first}:remove")
	...
	@PostMapping("get")
	@ApiOperation(value="通过id获取${table.remark?replace("表","")}", notes="${moduleName}:${table.tableCameName?replace(moduleName,"")?uncap_first}:get")
	...
	@PostMapping("list")
	@ApiOperation(value="分页查询${table.remark?replace("表","")}", notes="${moduleName}:${table.tableCameName?replace(moduleName,"")?uncap_first}:list")
